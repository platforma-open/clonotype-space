...
- 62c8bfe: Hide the multiple sequence alignment entry point for peptide datasets, including the table cell button.

## 3.7.0

### Minor Changes

- 73bbfdb: Speed up the CPU transform phase, and cap SVD dimensionality on large inputs
...
- Updated dependencies [feac133]
  ...
  - @platforma-open/milaboratories.clonotype-space.ui@3.3.2
...
- Updated dependencies [ccc4b64]
  ...
  - @platforma-open/milaboratories.clonotype-space.ui@3.3.1
  - @platforma-open/milaboratories.clonotype-space.workflow@3.4.2
