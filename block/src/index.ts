...
export type ClonotypeSpaceBlockContract = BlockContract;
export type ClonotypeSpaceBlockOutputs  = BlockOutputs;
export type ClonotypeSpaceBlockData     = BlockData;
export const ClonotypeSpaceBlockPointer = BlockPointer;
